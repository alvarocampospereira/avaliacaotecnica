...
type
  TfrmMenuPrincipal = class(TForm)
    ...
    mnConsultaiNegociacao: TMenuItem;
    mniCadastroNegociacao: TMenuItem;
    procedure mnConsultaiNegociacaoClick(Sender: TObject);
    procedure mniCadastroNegociacaoClick(Sender: TObject);
...
uses ufrmCadastroProduto, ufrmCadastroDistribuidor, UfrmCadastroProdutor,
  UfrmCadastroNegociacao, UfrmManutencaoNegociacao, UfrmConsultaNegociacao;
...
procedure TfrmMenuPrincipal.mniCadastroNegociacaoClick(Sender: TObject);
begin
  // cadastro negociação
  criarJanela(tfrmCadastroNegociacao, frmCadastroNegociacao);
end;
...
begin
  ...
  criarJanela(TfrmManutencaoNegociacao, frmManutencaoNegociacao);
end;

procedure TfrmMenuPrincipal.mnConsultaiNegociacaoClick(Sender: TObject);
begin
  // consulta negociação
  criarJanela(TfrmConsultaNegociacao, frmConsultaNegociacao);
end;
