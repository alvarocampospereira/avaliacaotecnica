...
type
  TdtmProduto = class(TDataModule)
    ...
    procedure cdsProdutoVALORVENDAGetText(Sender: TField; var Text: string;
      DisplayText: Boolean);
...
procedure TdtmProduto.cdsProdutoVALORVENDAGetText(Sender: TField;
