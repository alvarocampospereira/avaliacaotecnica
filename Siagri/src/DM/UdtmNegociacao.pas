...
type
  TdtmNegociacao = class(TDataModule)
    ...
    sdsConsultaNegSTATUS: TStringField;
    sdsConsultaNegID_PRODUTOR: TIntegerField;
    sdsConsultaNegNOMEPRODUTOR: TStringField;
    sdsConsultaNegID_DISTRIBUIDOR: TIntegerField;
    sdsConsultaNegNOMEDISTRIBUIDOR: TStringField;
    sdsConsultaNegDATACADASTRO: TDateField;
    sdsConsultaNegVALORTOTAL: TFMTBCDField;
    sdsConsultaNegDATAAPROVACAO: TDateField;
    sdsConsultaNegDATACONCLUSAO: TDateField;
    sdsConsultaNegDATACANCELAMENTO: TDateField;
    cdsConsultaNegSTATUS: TStringField;
    cdsConsultaNegID_PRODUTOR: TIntegerField;
    cdsConsultaNegNOMEPRODUTOR: TStringField;
    cdsConsultaNegID_DISTRIBUIDOR: TIntegerField;
    cdsConsultaNegNOMEDISTRIBUIDOR: TStringField;
    cdsConsultaNegDATACADASTRO: TDateField;
    cdsConsultaNegVALORTOTAL: TFMTBCDField;
    cdsConsultaNegDATAAPROVACAO: TDateField;
    cdsConsultaNegDATACONCLUSAO: TDateField;
    cdsConsultaNegDATACANCELAMENTO: TDateField;
    cdsConsultaNegDescricaoStatus: TStringField;
    sdsNegociacaoCODIGOCONTRATO: TIntegerField;
    cdsNegociacaoCODIGOCONTRATO: TIntegerField;
    sdsConsultaNegCODIGOCONTRATO: TIntegerField;
    cdsConsultaNegCODIGOCONTRATO: TIntegerField;
    procedure cdsConsultaNegVALORTOTALGetText(Sender: TField; var Text: string;
      DisplayText: Boolean);
    procedure cdsConsultaNegCalcFields(DataSet: TDataSet);
...
procedure TdtmNegociacao.cdsConsultaNegCalcFields(DataSet: TDataSet);
begin
  cdsConsultaNegDescricaoStatus.AsString := obterNomeStatus(cdsConsultaNegSTATUS.AsString);
end;

procedure TdtmNegociacao.cdsConsultaNegVALORTOTALGetText(Sender: TField;
